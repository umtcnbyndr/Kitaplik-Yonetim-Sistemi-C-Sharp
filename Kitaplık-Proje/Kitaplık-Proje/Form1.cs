...
namespace Kitaplık_Proje
{
    public partial class Form1 : Form
    {
        ...
        OleDbConnection baglanti = new OleDbConnection(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\umtcn\Desktop\Kitaplik.mdb");
        ...
        {
            baglanti.Open();
            OleDbCommand komut1 = new OleDbCommand("insert into kitaplar (KitapAd,Yazar,Tur,Sayfa) values(@p1,@p2,@p3,@p4)", baglanti);
        ...
        //Günceleme kısmında sıkıntı var
